...
public class RemixerFiller {
	...
	private String fileName = "Riot XXXtentaction";	// this should match your txt file
	
	private String[] wordsToReplace;	// for part 2, if you finish the main project
	private String[] newWords;
	
	public void remix() {
		wordsToReplace = new String[] {"nigga", "niggas", "fuck", "fuckin", "shit"};
		newWords = new String[] {"person", "people", "screw", "freakin", "stuff" };
		// your code here
